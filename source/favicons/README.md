...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#4594b5">
    <link rel="shortcut icon" href="/favicons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Hellolin の 小破窝">
    <meta name="application-name" content="Hellolin の 小破窝">
